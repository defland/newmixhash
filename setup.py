...
lyra2z_hash_module = Extension('lyra2z_hash',
                               sources = [
                                          'mixhash/lyra2z/lyra2remodule.c',
                                          'mixhash/lyra2z/Lyra2RE.c',
                                          'mixhash/lyra2z/Sponge.c',
                                          'mixhash/lyra2z/Lyra2z.c',
                                          'mixhash/sha3/blake.c',
                                          'mixhash/sha3/groestl.c',
                                          'mixhash/sha3/keccak.c',
                                          'mixhash/sha3/cubehash.c',
                                          'mixhash/sha3/bmw.c',
                                          'mixhash/sha3/skein.c'],
                               include_dirs=['mixhash/lyra2z','mixhash/sha3'])
...
setup (	name = 'mixhash',
        ...
        ext_modules = [ lyra2z_hash_module,lyra2re_hash_module, qubit_hash_module, keccak_hash_module, neoscrypt_module, x11_hash_module])
